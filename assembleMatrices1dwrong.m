...
function [A, b, G, D, K, cells, edges] = assembleMatrices1dwrong(num_cells, f, k1)
...
%     grad_occupation_j((2*i-1):2*i) = edges(i,2:3);
%     grad_values((2*i-1):2*i) = [-1,1]/dx; 
%     diffusion_values((2*i-1):2*i) = 2*[1,1]/(1/k1(cells(edges(i,2),1))+1/k1(cells(edges(i,3),1)));
% end
