...
\begin{itemize}
	...
	\item The problem arrives when we do not know the real solution: we can not use the efficiency index to know how accurate is our bound.
	\item If we had a minorant we could study the gap between minorant and majorant to get conclusions about our bounds.
\end{itemize}
\end{frame}
